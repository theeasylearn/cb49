...
void main()
{
    ...
    //== used to check 2 variable has same value or not
    result = a == b; //0
    printf("\n%d = %d == %d",result,a,b);



    // != used to check 2 variable has different value or not
    result = a != b; //  10 != 11
    printf("\n%d = %d != %d",result,a,b);

    //<  used to check whether left side variable is less then right side variable or not
    result = a < b; // 10 < 11
    printf("\n%d = %d < %d",result,a,b);

    //>  used to check whether right side variable is greater then left side variable or not
    result = a > b; // 10 > 11
    printf("\n%d = %d > %d",result,a,b);


    //<= used to check left side variable is less then or equal to right side variable
    result = a <= b; // 10 <= 11
    printf("\n%d = %d <= %d",result,a,b);

    // >=used to check right side variable is greater then or equal to left side variable
    result = a >= b; // 10 >= 11
    printf("\n%d = %d >= %d",result,a,b);
